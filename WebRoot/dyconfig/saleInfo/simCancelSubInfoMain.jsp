...
<html>
   ...
   /*  var st = new Date(frmGo.startTime.value.replace(/-/g,'/'));
	...
	function insert(){
		frmGo.action = "doSaleInfo.do?method=initInsert";
		frmGo.submit();
	}
	...
	<body>
		...
		<form name="frmGo" method="post" action="doSaleInfo.do?method=queryCancelSubInfo">						
               ...
               <tr>
				...
				<%-- 	项目名		
                  ...
                  <!-- 	<td width="10%">IMEI</td>  -->
                  	...
                  	<td width="10%" >创建时间</td>
                  	<td width="5%" >CardStatus</td>
                  	<td width="10%" >订阅者id</td>
                  	<td width=10%" >订阅id</td>
                  	<td width="10%" >到期时间</td>
                  	<td width="10%" >操作</td>

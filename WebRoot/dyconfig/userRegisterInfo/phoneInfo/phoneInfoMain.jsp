               ...
               <tr>
				...
				<logic:iterate id="element" name="pageList">
					<tr class="tr_5" onmouseover='this.className="tr_4"' onmouseout='this.className="tr_5"' >						
						...
						<td>
						<logic:equal name="element" property="fall_on" value="0">不开</logic:equal>
						<logic:equal name="element" property="fall_on" value="1">开</logic:equal>
						</td>
						
						<td>
						<logic:equal name="element" property="device_type" value="0">第一代</logic:equal>
						<logic:equal name="element" property="device_type" value="1">第二代</logic:equal>
						</td>

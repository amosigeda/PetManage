...
<form name="frm" method="post" action="doPhoneInfo.do?method=addImei" onsubmit="return onAdd()">
  <p>请选择录入类型:</p>
  	...
  	<input type="radio" name="addType" value="1" />Excel-IMEI-ICCID录入</br>
  	  <!-- 	<input type="radio" name="addType" value="2"/>文本录入  -->
  		<input type="radio" name="addType" value="3" />Excel-IMEI录入</br>
  		<input type="radio" name="addType" value="4" />ICCID-IMSI-爱施德-录入</br>

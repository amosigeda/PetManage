...
<form name="frmGo" method="post" action="doPhoneInfo.do?method=singleImeiIccid" onsubmit="return onAdd()">
  	<table>
  
  		
  			<tr>
  			<td>IMEI:</td>
  			<td><input type="text" name="imei" id="imei" size="25"/></td>
  		</tr>
  			<tr>
  			<td>ICCID:</td>

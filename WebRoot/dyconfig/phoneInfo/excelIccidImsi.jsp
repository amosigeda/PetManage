...
<form name="frmGo" method="post" action="doPhoneInfo.do?method=excelIccidIsmi" encType="multipart/form-data" onsubmit="return onAdd()">
  	<p>EXCEL-ICCID-IMSI录入：</p>

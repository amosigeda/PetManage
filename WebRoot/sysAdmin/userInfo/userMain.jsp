               ...
               <tr class="title_3">
				...
				<logic:iterate id="element" name="pageList">
					<tr class="tr_5" onmouseover='this.className="tr_4"' onmouseout='this.className="tr_5"' >
						...
						<logic:equal name="element" property="code" value="admin">超级管理员</logic:equal>
						<logic:equal name="element" property="code" value="manager">管理员</logic:equal>
						<logic:equal name="element" property="code" value="operator">操作员</logic:equal>
							
						<%-- <logic:empty name="element" property="code">超级管理员</logic:empty>
						<logic:notEmpty name="element" property="code">						  
						     <bean:write name="element" property="code" value="admin"/>
						     </logic:notEmpty> --%>

...
public class SqlMapRoleInfoDao extends SqlMapClientDaoSupport implements
		RoleInfoDao {
	...
	public Integer getRoleInfoCount(DataParamMap dmap)
			throws DataAccessException {
		logger.debug("getRoleInfoCount(DataParamMap dmap)");
		return (Integer) getSqlMapClientTemplate().queryForObject(
				"getRoleInfoCountMap", dmap);
	}
	...
	public List<DataMap> getRoleInfoListByVo(RoleInfo vo)
			throws DataAccessException {
		logger.debug("getRoleInfoListByVo(RoleInfo vo)");
		return getSqlMapClientTemplate()
				.queryForList("getRoleInfoListByVo", vo);
	}

	public List<DataMap> getRoleInfoListByMap(DataParamMap dmap)
			throws DataAccessException {
		logger.debug("getRoleInfoListByMap(DataParamMap dmap)");
		return getSqlMapClientTemplate().queryForList("getRoleInfoListByMap",
				dmap);
	}
	...
	public List<DataMap> selectPermission(RoleInfo vo)
			throws DataAccessException {
		logger.debug("selectPermission(RoleInfo vo)");
		return getSqlMapClientTemplate().queryForList("selectPermission", vo);
	}

	public List<DataMap> ideaStatusInfo(RoleInfo vo) throws DataAccessException {
		logger.debug("ideaStatusInfo(RoleInfo vo)");
		return getSqlMapClientTemplate().queryForList("ideaStatusInfo", vo);
	}

	public int updateIdeaStatus(RoleInfo vo) throws DataAccessException {
		logger.debug("updateIdeaStatus(RoleInfo vo)");
		return getSqlMapClientTemplate().update("updateIdeaStatus", vo);
	}
}

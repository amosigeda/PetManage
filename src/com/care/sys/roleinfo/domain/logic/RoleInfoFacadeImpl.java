...
//            }
	...
	public List<DataMap> selectPermission(RoleInfo vo) throws SystemException {
		return roleInfoDao.selectPermission(vo);
	}

	public List<DataMap> ideaStatusInfo(RoleInfo vo) throws SystemException {
		return roleInfoDao.ideaStatusInfo(vo);
	}

	public int updateIdeaStatus(RoleInfo vo) throws SystemException {
		return roleInfoDao.updateIdeaStatus(vo);
	}
}

...
public class SafeAreaFacadeImpl implements SafeAreaFacade{
	...
	public DataList getWeFencingInfo(SafeArea vo) throws SystemException {
		DataList list = new DataList(safeAreaDao.getWeFencingInfo(vo));
		list.setTotalSize(safeAreaDao.getgetWeFencingInfoCount(vo));
		return list;
	}
}

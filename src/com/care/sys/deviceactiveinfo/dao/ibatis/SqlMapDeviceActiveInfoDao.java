...
public class SqlMapDeviceActiveInfoDao extends SqlMapClientDaoSupport implements DeviceActiveInfoDao{
	...
	public int updateDeviceActiveInfonull(DeviceActiveInfo ddo)
			throws DataAccessException {
		// TODO Auto-generated method stub
		logger.debug("updateDeviceActiveInfonull(DeviceActiveInfo ddo)");
		return (Integer)getSqlMapClientTemplate().update("updateDeviceActiveInfonull", ddo);
	}
}

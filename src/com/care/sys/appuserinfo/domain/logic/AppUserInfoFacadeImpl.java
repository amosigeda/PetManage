...
public class AppUserInfoFacadeImpl implements AppUserInfoFacade{
	...
	public DataList getWAppUserInfoListByVo(AppUserInfo vo)
			throws SystemException {
		DataList list = new DataList(appUserInfoDao.getWAppUserInfoListByVo(vo));
		list.setTotalSize(appUserInfoDao.getWAppUserInfoCountByVo(vo));
		return list;
	}

	public Integer deleteAppUserInfo(AppUserInfo vo) throws SystemException {
		return appUserInfoDao.deleteAppUserInfo(vo);
	}

	public List<DataMap> selectTestInfo(AppUserInfo vo) throws SystemException {
		return appUserInfoDao.selectTestInfo(vo);
	}

	public int insertTestInfo(AppUserInfo vo) throws SystemException {
		return appUserInfoDao.insertTestInfo(vo);
	}

	public int updateTestInfo(AppUserInfo vo) throws SystemException {

		return appUserInfoDao.updateTestInfo(vo);

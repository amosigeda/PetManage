	...
	public static String getSelect(String status, int isSelect){
		...
		for(int i=0;i<6; i++){
			...
			if(i == 0){
				...
				sb.append("<option value='1'"+select+">高德GPS");
			}else if(i == 2){
				sb.append("<option value='2'"+select+">高德LBS");				
			}else if(i == 3){
				sb.append("<option value='3'"+select+">高德WIFI");				
			}else if(i == 4){
				sb.append("<option value='4'"+select+">Google GPS");				
			}else if(i == 5){
				sb.append("<option value='5'"+select+">Google Geolocation");				
			}			
		}
		sb.append("</select>");
